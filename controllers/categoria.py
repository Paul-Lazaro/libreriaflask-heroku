...
serializer.add_argument(
    ...
    location="json" #x defecto  intenta buscar en todos los campos posibles  y si lo encuentra no dara error  pero si queremos indicar excatmente porq medio me lo tiene q pasar debemos indicar el location
)
